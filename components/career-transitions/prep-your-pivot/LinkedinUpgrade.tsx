...
export default function LinkedInUpgrade({ onComplete, onBack }: LinkedInUpgradeProps) {
    ...
    const cards = [
        ...
        },
        {
            ...
            prompt: "Pick 10 (or choose your own!):\n\n• Project Coordination\n• Stakeholder Management\n• Public Speaking\n• Coaching\n• Event Ops\n• Content Creation\n• Customer Service\n• Time Management\n• Team Leadership\n• Visual Storytelling",
