                ...
                >
                    <View style={commonStyles.centeredContent}>
                        <Card style={commonStyles.baseCard}>
                            ...
                            <Text style={commonStyles.introTitle}>Cure Imposter Syndrome</Text>
                        ...
                        <Card style={commonStyles.baseCard}>
                            <View style={styles.voiceIcon}>
                                <TouchableOpacity
                                    ...
                                    accessibilityLabel={isPlaying ? 'Pause imposter syndrome visualization' : 'Play imposter syndrome visualization'}
                                >
                                    <View
                            ...
                            <Text style={styles.voiceTitle}>Overcome Imposter Syndrome</Text>

                            <Text style={styles.voiceDescription}>
                                {!isPlaying && "Tap to listen to a guided exercise for overcoming imposter syndrome"}
                            </Text>
                    ...
                    <View style={commonStyles.centeredContent}>
                        <Card style={commonStyles.baseCard}>
                            ...
                            <Text style={commonStyles.reflectionDescription}>
                                Take a moment to capture your thoughts and feelings after the imposter syndrome exercise. What insights emerged about your capabilities and worth?
                            </Text>
            ...
            >
                <View style={commonStyles.centeredContent}>
                    <Card style={commonStyles.baseCard}>
                        ...
                        <Text style={styles.ebookTitle}>Ready for More Guidance?</Text>
                        ...
                        <Text style={styles.ebookCallout}>
                            Your dream career is within reach. Let's make it happen together.
                        </Text>
                            ...
                            <View style={styles.ebookCardContent}>
                                ...
                                <View style={styles.ebookFeatures}>
                                    ...
                                    <View style={styles.featureItem}>
                                        ...
                                        <Text style={styles.featureText}>Real-life dancer success stories</Text>
                                    </View>
                                    <View style={styles.featureItem}>
                                        <Target size={16} color="#928490" />
                                        <Text style={styles.featureText}>Actionable exercises and worksheets</Text>
                                    </View>
                                </View>
