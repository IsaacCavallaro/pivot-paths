...
export default function CureImposterSyndrome({ onComplete }: CureImposterSyndromeProps) {
    const [isPlaying, setIsPlaying] = useState(false);
    const [currentScreen, setCurrentScreen] = useState(0); // 0 = main screen, 1 = ebook promotion
