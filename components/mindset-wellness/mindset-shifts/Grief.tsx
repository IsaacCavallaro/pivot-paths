                ...
                >
                    <View style={commonStyles.centeredContent}>
                        <Card style={commonStyles.baseCard}>
                            ...
                            <Text style={commonStyles.introTitle}>Navigating Grief</Text>
                ...
                >
                    <View style={commonStyles.centeredContent}>
                        <Card style={commonStyles.baseCard}>
                            ...
                            <Text style={styles.voiceTitle}>Processing Grief</Text>

                            <Text style={styles.voiceDescription}>
                                {!isPlaying && "Tap to listen to a guided grief processing exercise"}
                            </Text>
                    ...
                    <View style={commonStyles.centeredContent}>
                        <Card style={commonStyles.baseCard}>
                            ...
                            <Text style={commonStyles.reflectionDescription}>
                                Take a moment to capture your thoughts and feelings after the grief processing exercise. What emotions surfaced? What insights emerged about your journey?
                            </Text>
                ...
                <View style={commonStyles.centeredContent}>
                    <Card style={commonStyles.baseCard}>
                        ...
                        <Text style={styles.ebookCallout}>
                            Your future is waiting to be built. Let's create it together.
                        </Text>
                            ...
                            <View style={styles.ebookCardContent}>
                                ...
                                <View style={styles.ebookFeatures}>
                                    <View style={styles.featureItem}>
                                        ...
                                        <Text style={styles.featureText}>Values identification exercises</Text>
                                    </View>
                                    <View style={styles.featureItem}>
                                        <Users size={16} color="#928490" />
                                        <Text style={styles.featureText}>Real-life transition stories</Text>
                                    </View>
                                    <View style={styles.featureItem}>
                                        <Target size={16} color="#928490" />
                                        <Text style={styles.featureText}>Actionable planning tools</Text>
                                    </View>
                                </View>
