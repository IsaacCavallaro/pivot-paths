                ...
                >
                    <View style={commonStyles.centeredContent}>
                        <Card style={commonStyles.baseCard}>
                            ...
                            <Text style={commonStyles.introTitle}>A New You</Text>
                    ...
                    <View style={commonStyles.centeredContent}>
                        <Card style={commonStyles.baseCard}>
                            ...
                            <Text style={commonStyles.reflectionDescription}>
                                Take a moment to capture your thoughts and feelings after the visualization exercise. What did you discover about the new version of yourself? How does this balanced person show up in the world?
                            </Text>
