                ...
                >
                    <View style={commonStyles.centeredContent}>
                        <Card style={commonStyles.baseCard}>
                            ...
                            <Text style={commonStyles.introTitle}>Money Mindset Reflection</Text>
                ...
                >
                    <View style={commonStyles.centeredContent}>
                        <Card style={commonStyles.baseCard}>
                            ...
                            <Text style={styles.voiceTitle}>Money Mindset Reflection</Text>

                            <Text style={styles.voiceDescription}>
                                {!isPlaying && "Tap to listen to a guided reflection on overcoming financial shame"}
                            </Text>
                ...
                >
                    <View style={commonStyles.centeredContent}>
                        <Card style={commonStyles.baseCard}>
                            ...
                            <Text style={styles.journalTitle}>Reflect on Your Money Mindset</Text>

                            <Text style={commonStyles.reflectionDescription}>
                                Take a moment to capture your thoughts and feelings about money after the reflection exercise. What insights emerged about your relationship with finances?
                            </Text>
                            ...
                            <View style={styles.ebookCardContent}>
                                ...
                                <View style={styles.ebookFeatures}>
                                    <View style={styles.featureItem}>
                                        ...
                                        <Text style={styles.featureText}>Actionable goal-setting exercises</Text>
                                    </View>
                                    <View style={styles.featureItem}>
                                        <Users size={16} color="#928490" />
                                        <Text style={styles.featureText}>Real-life success stories</Text>
                                    </View>
                                    <View style={styles.featureItem}>
